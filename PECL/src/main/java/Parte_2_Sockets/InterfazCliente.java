...
public class InterfazCliente extends javax.swing.JFrame 
{
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(25, 25, 25)
                        .addComponent(numActividades, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void consultarColaEsperaTirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarColaEsperaTirActionPerformed
        ...
        consulta = 1;   //Número de consulta 1
        resultadoTam = 0;   //Resultado inicial
        try
        {
            salida.writeInt(consulta);                                 // Enviamos a servidor que consulta queremos realizar
            resultadoTam = entrada.readInt();                          // Leemos resultado de la consulta
            colaEsperaTirolina.setText(" " + resultadoTam);            //Mostramos en interfaz dato recibido     
        }
        catch (IOException e)
        {
    ...
    private void consultarColaEsperaSogaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarColaEsperaSogaActionPerformed
        consulta = 2;   //Número de consulta
        resultadoTam = 0;   //Resultado inicial
        try
        {
            salida.writeInt(consulta);                                 // Enviamos que consulta queremos realizar a servidor
            resultadoTam = entrada.readInt();                          // Leemos resultado de la consulta
            colaEsperaSoga.setText(" " + resultadoTam);                //Mostramos por pantalla el resultado 
        }
        catch (IOException e)
        {
            System.out.println("Error: " + e.getMessage());
    ...
    private void consularNiñosMerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consularNiñosMerActionPerformed
        consulta = 3;   //Número de consulta
        resultadoTam = 0;
        try
        {
            salida.writeInt(consulta);                                 // Enviamos que consulta queremos realizar a servidor
            resultadoTam = entrada.readInt();                          // Leemos resultado de la consulta
            niñosMerendando.setText(" " + resultadoTam);              //Mostramos por pantalla el resultado de la consulta
        }
        catch (IOException e)
        {
            System.out.println("Error: " + e.getMessage());
    ...
    private void consultarBandejasSucActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarBandejasSucActionPerformed
        consulta = 4;   //Número de consulta
        resultadoS = " ";   //Resultado inicial
        try
        {
            salida.writeInt(consulta);                                 // Enviamos que consulta queremos realizar
            resultadoS = entrada.readUTF();                            // Leemos resultado de la consulta
            bandejasSucias.setText(resultadoS);                        //Mostramos por pantalla el resultado de la consulta
        }
        catch (IOException e)
        {
            System.out.println("Error: " + e.getMessage());
    ...
    private void consultarBandejasLimpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarBandejasLimpActionPerformed
        consulta = 5;   //Número de consulta
        resultadoS = " ";   //Resultado inicial
        try
        {
            salida.writeInt(consulta);                                 // Enviamos qeu consulta queremos realizar
            resultadoS = entrada.readUTF();                            // Leemos resultado de la consulta
            bandejasLimpias.setText(resultadoS);                        //Mostramos resultado de la consulta en interfaz
        }
        catch (IOException e)
        {
            System.out.println("Error: " + e.getMessage());
    ...
    private void consultarNumeroUsosTirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarNumeroUsosTirActionPerformed
        consulta = 6;   //Numero de consulta
        resultadoTam = 0;
        try
        {
            salida.writeInt(consulta);                                  // Enviamos qeu consulta queremos realizar
            resultadoTam = entrada.readInt();                           // Leemos resultado de la consulta
            numeroUsosTir.setText(" " + resultadoTam);                  //Mostramos resultado de consulta por interfaz         
        }
        catch (IOException e)
        {
            System.out.println("Error: " + e.getMessage());
    ...
    private void consultarIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultarIdActionPerformed
        ...
        if(!idChild.getText().isEmpty()) //Si el espacio dónde que hay introducir id del niño a consultar no esta vacio
        {
            ...
            {
                salida.writeInt(consulta);                                   // Enviamos que consulta queremos realizar a servidor
                salida.writeUTF(id);                                         //Enviamos id del niño cuya información queremos analizar
                resultadoTam = entrada.readInt();                            // Leemos resultado de la consulta
                if (resultadoTam == -1)   errorId.setText("No encontrado");    //Si no se encuentra niño por su id muestra error en pantalla
                else numActividades.setText(" " + resultadoTam);                 //Mostramos por pantalla resultado de la consulta
            }
            catch (IOException e)
            {
               System.out.println("Error: " + e.getMessage());
    ...
    private void botonSalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonSalirActionPerformed
        try
        {
            salida.writeInt(999);   //Paar indicar que no es ninguna de las consultas anteriores
            resultadoS = entrada.readUTF(); //Recibe resultado
            if( resultadoS.equals("desconectado"))  //Si resultado recibido es mensaje desconectado se ha hecho correctamente el cierro de conexión con el servidor
            {
                entrada.close();    //cierra canal de entrada
                salida.close();     //cierra canal de salida
                cliente.close();    //cierra conexión 
