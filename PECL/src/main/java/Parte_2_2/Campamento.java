...
public class Campamento 
{
    ...
    //Método para consultar número de niños en la cola de espera de actividad tirolina
    public int getColaTirolina() 
    {
        return colaTirolina.getTamaño();   //Muestra tamaño de la cola de tirolina en interfaz
    }
    
    //Método para sonsultar número de niños en la cola de espera de actividad sogae
    public int getColaSoga() 
    {
        return  childEnSoga.getTamaño();    //Muestra tamaño cola de la soga en interfaz
    }
    
    //Método método para conusltar número de niños en actividad merienda
    public int getMerendero() 
    {
        return childEnMer.getTamaño();    //Muestra número de niñso en merendero
    }
    
    //Método para consultar  número de bandejas limpias en merendero
    public String getBandejasLimpias() 
    {
        return limpias.contenido();  //Muestra número de bandejas limpias
    }
    
    //Método para consultar número de bandejas sucias en merendero
    public String getBandejasSucias() 
    {
        return sucias.contenido();   //Muestra número de bandejas limpias
    }
    
    //Método para consultar número de veces que se ha realizado actividad tirolina
    public int getVecesTirolina() 
    {
        return contTir;    //Muestra número de veces se ha llevado a cabo actividad tirolina
    }
    
    //Método para consultar número de actividades que ha realizado un niño
    public int getActChild(String id) 
    {
