...
public class Campamento {
    ...
    public synchronized int consultarColaTirolina()
    {
    ...
    public synchronized int consultarColaSoga()
    {
    ...
    public synchronized int consultarMerendero()
    {
    ...
    public synchronized int consultarVecesTirolina()
    {
